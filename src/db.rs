...
pub trait UserExt {
    async fn get_user(
        ...
        name: Option<&str>,
        email: Option<&str>,
        verification_token: Option<&str>, // Renamed parameter here
...
impl UserExt for DBClient {
    async fn get_user(
        ...
        } else if let Some(verification_token) = verification_token { // Renamed variable here
            user = sqlx::query_as!(
                User,
                r#"
                ...
                verification_token // Used renamed variable here
            )
